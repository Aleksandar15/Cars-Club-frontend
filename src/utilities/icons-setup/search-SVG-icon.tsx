  ...
  return (
    <>
      ...
      >
        ...
        <path
          fill="url(#C4TdsG345VslfSD6bqYyXa)"
          d="M25,14.001c-5,0-9.002,3.999-9.002,8.999H25V14.001z"
        />
        <linearGradient
          id="C4TdsG345VslfSD6bqYyXb"
          x1="24.511"
          x2="26.011"
          y1="5.27"
          y2="59.777"
        ...
        <path
          fill="url(#C4TdsG345VslfSD6bqYyXb)"
        ...
        <path
          fill="url(#C4TdsG345VslfSD6bqYyXc)"
